...
require_once 'Zend/Filter/ArrayTest.php';
require_once 'Zend/Filter/BuilderTest.php';
require_once 'Zend/Filter/Builder/AllTests.php';
...
class Zend_Filter_AllTests
{
    ...
    public static function suite()
    {
        ...
        // Add suites here
        $suite->addTestSuite('Zend_Filter_ArrayTest');
        $suite->addTestSuite('Zend_Filter_BuilderTest');
        $suite->addTest(Zend_Filter_Builder_AllTests::suite());
