 ...
 * @version    $Id: Select.php 5795 2007-07-20 15:45:08Z mikespook $
 */
...
class Zend_Db_Select
{
    ...
    {
        $sql = array('SELECT');
        foreach (array_keys($this->_partsInit) as $part) {
            $method = '_render' . ucfirst($part) . 'ClauseToString';
     ...
     * @return string
     */
    protected function _renderDistinctClauseToString()
    {
     ...
     * @return string
     */
    protected function _renderForupdateClauseToString()
    {
     ...
     * @return string
     */
    protected function _renderFromClauseToString()
    {
        /*
        ...
        foreach ((array) $this->_parts[self::FROM] as $correlationName => $table) {
            $tmp = '';
            if (empty($from)) {
                /*
     ...
     * @return string
     */
    protected function _renderWhereClauseToString()
    {
        if ($this->_parts[self::FROM] && $this->_parts[self::WHERE]) {
            return 'WHERE ' .  implode(' ', $this->_parts[self::WHERE]);
        }
        return null;
    }
     ...
     * @return string
     */
    protected function _renderGroupClauseToString()
    {
     ...
     * @return string
     */
    protected function _renderHavingClauseToString()
    {
     ...
     * @return string
     */
    protected function _renderOrderClauseToString()
    {
     ...
     * @return string
     */
    protected function _renderLimitoffsetClauseToString()
    {
        $count = 0;
        $offset = 0;
