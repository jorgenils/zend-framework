 ...
 * @version    $Id: Posts.php 124 2007-04-16 22:40:30Z gavin $
 */
...
class ZFDemoModel_Posts extends Zend_Db_Table_Abstract
{
    ...
    public static function submit($userId, $topicId, $subject, $body)
    {
        ...
        $abort = ignore_user_abort(true); // don't stop saving the post, if the user presses "STOP" in their browser
        ...
        ignore_user_abort($abort); // restore the previous setting
    }
}
