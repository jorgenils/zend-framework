<!-- BEGIN: default/views/scripts/footer.php -->
    <hr>
        <?php if ($this->authenticationId): ?>
            <p>Application-Wide Actions: <a href="<?php echo $this->baseUrl ?>/logon/logout">Logout</a> (<span style='font-weight:bold; color:maroon'><b><?php echo $this->authenticationId['username'] ?></b></span>)</p>
        <?php endif; ?>
    <p>
