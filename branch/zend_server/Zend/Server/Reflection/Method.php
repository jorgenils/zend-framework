...
class Zend_Server_Reflection_Method
{
    ...
    /**
     * Method name (as used by service)
     * @var string 
     */
    protected $_name;
     ...
     */
    public function __construct(Reflector $r, $name = null, $argv = array())
    {
    ...
    public function setName($name)
    {
        if (!is_string($name) || !preg_match('/[a-z0-9_]+/i', $name)) {
            throw new Zend_Server_Reflection_Exception('Invalid method name');
        }
    ...
    /**
     * Return actual function/method name as defined
     * 
     * @return string
     */
    ...
    /**
     * Determine the callback type, function or method
     * 
     * @return string 'function' or 'method'
     */
