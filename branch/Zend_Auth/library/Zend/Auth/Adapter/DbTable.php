...
class Zend_Auth_Adapter_DbTable implements Zend_Auth_Adapter_Interface
{
     ...
     *
     * @var mixed $returnColumns
     * @var mixed $omitColumns
     * @return stdClass
     */
    ...
    public function authenticate()
    {
        ...
        if (count($resultIdentities) < 1) {
            ...
            $authResult['code'] = Zend_Auth_Result::FAILURE_IDENTITY_TOO_AMBIGIOUS;
        ...
        if ($resultIdentity['zend_auth_credential_match'] != '1') {
            $authResult['code'] = Zend_Auth_Result::FAILURE_INVALID_CREDENTIAL;
