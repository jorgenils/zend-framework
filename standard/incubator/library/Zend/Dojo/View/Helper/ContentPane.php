 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class Zend_Dojo_View_Helper_ContentPane extends Zend_Dojo_View_Helper_Abstract
{
    /**
     * Dijit being used
     * @var string
     ...
     * @return string
     */
    public function contentPane($id, $content, array $params = array(), array $attribs = array())
    {
