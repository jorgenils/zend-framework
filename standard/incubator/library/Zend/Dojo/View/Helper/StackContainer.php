 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class Zend_Dojo_View_Helper_StackContainer extends Zend_Dojo_View_Helper_Abstract
{
    /**
     * Dijit being used
     * @var string
     ...
     * @return string
     */
    public function stackContainer($id, $content, array $params = array(), array $attribs = array())
    {
