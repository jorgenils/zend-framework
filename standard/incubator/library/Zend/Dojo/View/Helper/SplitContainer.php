 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
  */
class Zend_Dojo_View_Helper_SplitContainer extends Zend_Dojo_View_Helper_Abstract
{
    /**
     * Dijit being used
     * @var string
     ...
     * @return string
     */
    public function splitContainer($id, $content, array $params = array(), array $attribs = array())
    {
