...
/**
 * @see Zend_Data_Paginator_ScrollingStyle_Elastic
 */
require_once 'Zend/Data/Paginator/ScrollingStyle/Elastic.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend_Data_Paginator_ScrollingStyle_ElasticTest extends PHPUnit_Framework_TestCase
{
    /**
     * @var Zend_Data_Paginator_ScrollingStyle_Elastic
     */
    ...
    {
        parent::setUp();
        $this->_scrollingStyle = new Zend_Data_Paginator_ScrollingStyle_Elastic();
